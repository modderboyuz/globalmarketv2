...
export default function RegisterPage() {
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      toast.error(error.message || "Google orqali ro'yxatdan o'tish xatoligi")
      setLoading(false)
    }
  }
        ...
        <Card className="card-beautiful">
          ...
          <CardContent>
            <div className="space-y-4">
              <Button
                variant="outline"
                className="w-full bg-transparent h-12 hover:bg-gray-50 border-2 border-gray-200 hover:border-green-300 transition-all duration-300"
            ...
            <div className="mt-8 pt-6 border-t-2 border-gray-100">
              <div className="text-center text-sm text-gray-500">
                ...
                <Link
                  href="/login"
                  className="text-blue-600 hover:text-blue-800 font-medium hover:underline transition-colors mt-2 inline-block"
                >
                  Kirish
                </Link>
              </div>
